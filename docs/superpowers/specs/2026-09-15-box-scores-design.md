...
| 3rd / 4th down | attempts and conversions **excluding `no_play` rows** — the opposite of the efficiency filter. Including them gives HOU 8-of-18. A spike (`qb_spike`) counts as a snap from scrimmage here and for red-zone trips | 3-9 / 7-16 ✅ |
