...
const TERMS: { term: string; definition: string; id?: string }[] = [
  ...
  { term: "Complete Passer (QB Archetype)", id: "complete-passer",
    definition: "A quarterback with 4+ radar axes at the 70th percentile or above. Elite across efficiency, accuracy, volume, depth, ball security, and consistency." },
  { term: "Playmaker (QB Archetype)", id: "playmaker",
    definition: "A high-efficiency, high-volume quarterback who drives the offense. Defined by Efficiency \u2265 70th, Volume \u2265 70th, and Consistency \u2265 60th percentile." },
  { term: "Gunslinger (QB Archetype)", id: "gunslinger",
    definition: "Pushes the ball downfield with aggression. Defined by Depth \u2265 65th, Volume \u2265 55th, and Ball Security \u2264 45th. Trades turnovers for big plays." },
  { term: "Surgeon (QB Archetype)", id: "surgeon",
    definition: "Precise and consistent passer. Defined by Accuracy \u2265 70th, Consistency \u2265 65th, and Efficiency \u2265 55th. Picks apart defenses without forcing throws." },
  { term: "Distributor (QB Archetype)", id: "distributor",
    definition: "High-volume, accurate short-game passer. Defined by Volume \u2265 70th, Accuracy \u2265 60th, and Depth \u2264 45th. Moves the chains underneath." },
  { term: "Volume Passer (QB Archetype)", id: "volume-passer",
    definition: "Throws at an extremely high rate with solid efficiency. Defined by Volume \u2265 80th and Efficiency \u2265 50th percentile." },
  { term: "Game Manager (QB Archetype)", id: "game-manager",
    definition: "Protects the football and avoids mistakes. Defined by Consistency \u2265 65th, Ball Security \u2265 65th, and Volume \u2264 45th." },
  { term: "Improviser (QB Archetype)", id: "improviser",
    definition: "Creates plays outside of structure. Defined by Efficiency \u2265 65th, 3+ axes \u2265 60th, and Accuracy \u2264 50th. High EPA despite inconsistent accuracy." },
  // --- WR Archetypes ---
  { term: "Alpha WR1 (WR Archetype)", id: "alpha-wr1",
    definition: "Dominant number-one receiver. Defined by 4+ radar axes \u2265 70th and Volume \u2265 65th. Commands targets and produces at an elite level." },
  { term: "Contested Catch WR (WR Archetype)", id: "contested-catch-wr",
    definition: "Wins downfield and at the catch point. Defined by Downfield \u2265 65th and Catch Rate \u2265 60th. High ADOT with reliable hands." },
  { term: "YAC Monster (WR Archetype)", id: "yac-monster",
    definition: "Dangerous after the catch. Defined by YAC/Rec \u2265 75th and Downfield \u2264 50th. Turns short throws into big gains." },
  { term: "Target Magnet (WR Archetype)", id: "target-magnet",
    definition: "Commands an elite target share. Defined by Volume \u2265 80th and Efficiency \u2265 45th. The offense runs through this receiver." },
  { term: "Field Stretcher (WR Archetype)", id: "field-stretcher",
    definition: "Stretches the field vertically. Defined by Downfield \u2265 75th and Catch Rate \u2264 50th. Trades catch rate for chunk plays." },
  { term: "Possession Receiver (WR Archetype)", id: "possession-receiver",
    definition: "Reliable hands and route precision. Defined by Catch Rate \u2265 70th, Consistency \u2265 60th, and Downfield \u2264 45th." },
  { term: "Deep Threat (WR Archetype)", id: "deep-threat",
    definition: "Pure vertical threat. Defined by Downfield \u2265 80th percentile. Lives on deep routes." },
  { term: "Efficient Producer (WR Archetype)", id: "efficient-producer",
    definition: "Maximizes every route run. Defined by Consistency (YPRR) \u2265 75th and Efficiency \u2265 65th with Volume \u2264 50th." },
  { term: "Playmaker (WR Archetype)", id: "playmaker-wr",
    definition: "Creates big plays through efficiency and after-catch ability. Defined by Efficiency \u2265 65th, YAC \u2265 65th, and 3+ axes \u2265 60th." },
  // --- RB Archetypes ---
  { term: "Three-Down Back (RB Archetype)", id: "three-down-back",
    definition: "Does it all. Defined by Volume \u2265 55th, Receiving \u2265 60th, Consistency \u2265 55th, and 2+ secondary axes \u2265 55th. Carries the load and catches passes." },
  { term: "Workhorse (RB Archetype)", id: "workhorse",
    definition: "High-volume carrier. Defined by Volume \u2265 70th, Efficiency \u2265 45th, and Receiving \u2264 45th. Grinds out production on the ground." },
  { term: "Power Back (RB Archetype)", id: "power-back",
    definition: "Runs through contact. Defined by Power \u2265 70th, Volume \u2265 50th, and Explosiveness \u2264 55th. Avoids getting stuffed." },
  { term: "Home Run Hitter (RB Archetype)", id: "home-run-hitter",
    definition: "Boom-or-bust runner. Defined by Explosiveness \u2265 75th and Consistency \u2264 45th. Trades consistency for chunk plays." },
  { term: "Pass-Catching Back (RB Archetype)", id: "pass-catching-back",
    definition: "Receiving weapon out of the backfield. Defined by Receiving \u2265 75th and Volume \u2264 50th." },
  { term: "Efficient Runner (RB Archetype)", id: "efficient-runner",
    definition: "High EPA on limited carries. Defined by Efficiency \u2265 70th, Consistency \u2265 60th, and Volume \u2264 55th." },
  { term: "Change of Pace (RB Archetype)", id: "change-of-pace",
    definition: "Maximizes limited touches. Defined by Efficiency \u2265 65th, Explosiveness \u2265 60th, and Volume \u2264 40th." },
  { term: "Bell Cow (RB Archetype)", id: "bell-cow",
    definition: "Dominates touches in the backfield. Defined by Volume \u2265 85th percentile. The clear lead back regardless of efficiency." },
];
