...
const TERMS: { term: string; definition: string; id?: string; section?: string }[] = [
  ...
  // --- Player Card ---
  {
    ...
    term: "OVR (Overall)",
    id: "ovr",
    definition: "A 0\u201399 rating shown on the player card: the average of a player\u2019s percentile ranks in his position\u2019s quality metrics. QB: EPA/dropback, CPOE, success rate, ball security, and rush EPA. WR/TE: EPA/target, CROE, yards per route run, and receiving success rate. RB: EPA/carry, success rate, stuff avoidance, and explosive rate. Style metrics (like aDOT) and volume metrics (like targets per game) appear on the card but do not affect OVR. Metrics a player has no data for are left out of the average rather than counted against him. Players below the per-game qualifying threshold (QB 14 attempts, WR/TE 2 targets, RB 6 carries per game) show \u201c\u2014\u201d instead of a score. RB OVR currently measures rushing only.",
  },
  // --- QB Archetypes ---
